...
1. Т.к меня выкинул коллаб во время обучения нейронки, распознающую пол, то графиков у меня нет(( Однако сохранены веса на первом этапе её обучения и как раз на них 
