...
2. Переделала модель, залила её в папку на гит models/
3. Я тоже хочу пользоваться процессором ноутбука, поэтому самое время перейти на гугл колаб
4. Да начнутся мои страдания
