...
2. Прочитала некоторые статьи из тех, что имелись + нашла новые на Scopus
3. Кстати, тексты докладов, которые скинули стажеры, не нашла. P.S Нашла
4. Урезала датасет, чтобы женщин/мужчин было 50/50 и чтобы он загружался на colab
5. Загрузила изменения на Drive
6. Теперь нет проблем со скоростью обучения на colab.
